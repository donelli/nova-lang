...
func PrintParseResultToHTML(parseRes *ParseResult, outputFile string) {
	...
	.for-node > .node-box-subnodes > span,
	.if-node > .node-box-subnodes > span,
	.func-call-node > .node-box-subnodes > span,
	.function-node > .node-box-subnodes > span {
		flex-direction: column;
		align-items: start;
	}

	.do-while-node > .node-box-subnodes > span > div,
	.for-node > .node-box-subnodes > span > div,
	.func-call-node > .node-box-subnodes > span > div,
	.function-node > .node-box-subnodes > span > div {
		margin-bottom: 5px;
	}
